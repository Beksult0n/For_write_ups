...
# ⚡ BEKSULTON — CYBERSECURITY RESEARCHER ⚡

<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=30&pause=1000&color=00FF99&center=true&vCenter=true&width=1000&lines=Cybersecurity+Researcher;Red+Team+Operator;CTF+Player;Bug+Bounty+Hunter;Malware+Analyst;Reverse+Engineer;OSINT+Researcher;Write-Ups+%26+Security+Research" />
...
```bash
> Initializing Cybersecurity Research Database...
...
<img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdjN6NnF2dzg4d3d0YjI5eW9uYjY0c2NrdW9ld3RrMzI3d2F6Z2FzNyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/l41lVsYDBC0UVQJCE/giphy.gif" width="900"/>
...
| Platform            | Account                                                                                              |
| ------------------- | ---------------------------------------------------------------------------------------------------- |
| 🟥 Hack The Box     | [https://app.hackthebox.com/profile/YOUR_USERNAME](https://app.hackthebox.com/profile/YOUR_USERNAME) |
| 🟦 TryHackMe        | [https://tryhackme.com/p/YOUR_USERNAME](https://tryhackme.com/p/YOUR_USERNAME)                       |
| 🟨 PicoCTF          | [https://play.picoctf.org/users/YOUR_USERNAME](https://play.picoctf.org/users/YOUR_USERNAME)         |
| 🟩 Root-Me          | [https://www.root-me.org/YOUR_USERNAME](https://www.root-me.org/YOUR_USERNAME)                       |
| 🟪 CTFtime          | [https://ctftime.org/user/YOUR_USERNAME](https://ctftime.org/user/YOUR_USERNAME)                     |
...
<img src="https://skillicons.dev/icons?i=linux,bash,python,js,php,mysql,docker,git,vscode" />

</div>

---

# 🛠️ TECHNOLOGIES & FIELDS
...
<a href="https://github.com/Beksult0n">
...
```diff
- This repository is created strictly for educational and authorized security research purposes only.
- Any illegal or unauthorized use of the information provided here is strictly prohibited.
```
